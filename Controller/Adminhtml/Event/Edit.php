...
class Edit extends AbstractEventController
{
    ...
    public function execute()
    {
        ...
        try {
            ...
            $this->messageManager->addErrorMessage("Can't load event: %1", $e->getMessage());
            $this->_redirect('*/*/index');
        }

        $page = $this->resultFactory->create(ResultFactory::TYPE_PAGE);
        $page->getConfig()->getTitle()->prepend('Edit: ' . $event->getName());
